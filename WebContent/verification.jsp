   ...
   <div class="col-md-8">
    <div class="marquee" style="border:2px black hidden; background-color:white; padding-top:0px;">
      ...
      <table class="tab hd brown">
		<tr>
			<td style="color:brown">first verify your email id to register</td>
		</tr>
	</table>
	...
	<table class="tab hd blue" border="0px" cellpadding="10" cellspacing="10">
		...
		<tr>
			<td>
				...
				<br>
					email id: &nbsp; <input type="email" name="email" placeholder="Enter Email" name="username" required="required" style="color:black;font-size:19px;"><br/><br/>
					
					
					<input type="submit" value="send otp" name="user">
				</form>
			</td>
