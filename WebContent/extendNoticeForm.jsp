...
<body>
   ...
   <div class="col-md-8">
    <!-- <div class="marquee" style="border:2px black hidden; background-color:white">
      ...
      --> 
     	...
     	<table style="border-radius:10px" >
			<tr >
				<td id="show" style="min-width:632px;min-height:0px;color:blue">Enter validity Details Below</td>
			</tr>
		</table>
      <%
	...
	<form action="extendNoticeSrv" method="post">
		<table style="background-color:white">
			<th colspan="2">extend validity of Notice No.<%=noticeId %><input type="hidden" name="nid" value="<%= noticeId%>"></th>
			<tr><td style="color:red"> Notice Title  : </td><td><input readonly type="text" name="title" required="required" value="<%= notice.getNoticeTitle()%>"></td></tr>
		   <tr><td style="color:red">	Descripton   : </td><td> <textarea readonly rows="4" cols="40" style="font-size:15px" name="info" required="required"><%= notice.getNoticeInfo() %></textarea></td></tr>
					<tr>
    <td style="color:red">Valid Until:</td>
    <td><input type="datetime-local" name="validity" required="required" value="<%= notice.getNoticeValidity() %>"></td>
</tr>
					
			<tr><td colspan="2" align="center" value="Launch"><input type="submit" style="background-color:#660033;color:white;" value="extend validity of This Notice"></td></tr>
