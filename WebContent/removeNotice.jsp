...
for (NoticeBean notice : noticeList) {
    ...
    String status = notice.getNoticeStatus(); // Get the status from the NoticeBean

    // Determine the button label based on the status
    String buttonLabel = (status.equalsIgnoreCase("expired")) ? "Extend validity" : "Archive";
%>
...
<tr>
    ...
    <td>
        ...
        <a href="extendNoticeForm.jsp?nid=<%= noticeId %>">
                <button class="btn btn-danger"><%= buttonLabel %></button>
            </a>
        <% } else { %>
