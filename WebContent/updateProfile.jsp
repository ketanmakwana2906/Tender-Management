   ...
   <div class="col-md-8">
	...
	<form action="UpdateProfileSrv" method="post">
		<table style="background-color:white">
		   ...
		   <tr><td style="color:red">	Mobile No.    :</td><td> <input readonly type="number" name="vmob" required="required" value="<%= vendor.getMobile()%>"></td></tr>
	       <tr><td style="color:red"> Email Id :</td><td> <input readonly type="email" name="vemail" required="required" value="<%= vendor.getEmail()%>"></td></tr>
