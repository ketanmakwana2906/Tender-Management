...
<body>
          ...
          &nbsp; Latest Updates and ongoing Notices</h4>
            ...
            <% 
                ...
                try{
                	...
                	PreparedStatement ps = con.prepareStatement("SELECT * FROM notice WHERE validity > NOW() AND status = 'active' ORDER BY validity ASC");
