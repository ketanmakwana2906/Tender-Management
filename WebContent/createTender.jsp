   ...
   <div class="col-md-8">
    <!-- <div class="marquee" style="border:2px black hidden; background-color:white">
      ...
      --> 
     	...
     	<table style="border-radius:10px" >
			<tr >
				<td id="show" style="min-width:645px;min-height:0px;color:blue"></td>
			</tr>
		</table>
	...
	<form action="CreateTenderSrv" method="post">
		<table style="background-color:white">
	       ...
	       <tr><td> Strict Deadline :</td><td> <input type="datetime-local" name="tdeadline" required="required"></td></tr>
	       	        <tr><td> Minimum Bidder <br>Experience <br> (in years) :</td><td> <input type="number" name="tbexp" required="required"></td></tr>
