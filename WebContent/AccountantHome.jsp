...
<body>
   ...
   <div class="col-md-8">
    <div class="marquee" style="border:2px black hidden; background-color:white ;width:150%;">
        ...
        &nbsp; <span id="pagetitle">Accountant</span></h4><!-- pagetitle id is given here -->
        <div class="marquee-content" style="align:center; padding-top:200px;min-height:750px;background-color:cyan ;  ">
     		<h1><center>Hey Accountant! Welcome to Our Tender Management system</center></h1>
     		<h2><center>Here You can manage payment of bids</center></h2>
     		<h3><center>you can accept bid for payment of admin approved bids</center></h3>
     		<h3><center>You can also manage payment dashboard of our payment gateway</center></h3>
      </div>
     </div>
     </div>
