   ...
   <div class="col-md-8">
    <div class="marquee" style="border:2px black hidden; background-color:white; padding-top:0px;">
      ...
      <table class="tab hd brown">
		<tr>
			<td style="color:brown">verify email</td>
		</tr>
	</table>
	...
	<table class="tab hd blue" border="0px" cellpadding="10" cellspacing="10">
		...
		<tr>
			<td>
				<form action="Otp1Servlet" method="post">
				<br>
					enter otp: &nbsp; <input type="text" name="otp" placeholder="Enter otp" required="required" style="color:black;font-size:19px;"><br/><br/>
					
					
					<input type="submit" value="submit otp" name="user">
				</form>
			</td>
