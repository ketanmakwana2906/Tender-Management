...
<body>
	...
	<%
	    ...
	    if(!(user.equalsIgnoreCase("admin") || user.equalsIgnoreCase("accountant")) || uname.equals("") || pword.equals("")){
   ...
   <div class="col-md-8">
     ...
     <table style="border-radius:10px" >
			<tr >
				<td id="show" style="min-width:730px;background-color:white;min-height:0px;color:red">All Assigned Tenders List</td>
			</tr>
	</table>
    
    
     <table style="background-color:white; margin-left:2%;">		
     		...
     		<tr> <td><%=status.getTendorId() %></td> 
     					<td><%=status.getVendorId() %></td> <td><%=status.getBidderId() %></td> 
