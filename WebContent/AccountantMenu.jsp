        ...
        <ul id="nav-list" class="nav navbar-nav navbar-left pull-left">
            ...
            <!-- <li class="dropdown">
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a href="viewactender.jsp">View all Tenders</a></li>
                  
                  <li><a href="AccviewTenderBids.jsp">View admin approved Tender Bids</a></li>
                  <li><a href="#">Accept a bid</a></li>
                  <li><a href="#">View Assigned Tenders</a></li>
                  </ul>
             </li>
