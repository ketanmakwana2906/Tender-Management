...
<body>
	...
	<div style="width: 119%;"><jsp:include page="AdminHeader.jsp"></jsp:include></div>

	<div style="width: 119%;"><jsp:include page="adminMenu.jsp"></jsp:include></div>

	<div class="clearfix hidden-sm hidden-xs"
		style="color: white; width: 119%; background-color: green; margin-top: -15px; margin-bottom: 12px">
