...
<body>
	...
	<div style="width: 110%;"> <jsp:include page="header.jsp"></jsp:include> </div>

	<div style="width: 110%;"> <jsp:include page="vendorMenu.jsp"></jsp:include> </div>

	<div class="clearfix hidden-sm hidden-xs"
		style="color: white; width: 110%; background-color: green; margin-top: -15px; margin-bottom: 12px">
	...
	errorPage="errorpage.jsp"%>
			...
			BidderDao dao = new BidderDaoImpl();
				...
				<tr>		<td><%=bidder.getBidId()%></td>
					...
					<td>pay 1% of tender base price = &#8377; <%=String.format("%.0f", (1/100.0) * tprice) %> to confirm order</td>
