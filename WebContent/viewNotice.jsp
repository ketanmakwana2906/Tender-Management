    ...
    <!-- <div class="marquee" style="border:2px black hidden; background-color:white">
     ...
     <table style="background-color:white">		
     		<tr style="color:white; font-size:22px; font-weight:bold;background-color:#660033">
     		 <td>Notice Id</td> <td>Title </td> <td> Description</td><td> Validity</td><td> Status</td> </tr>
     		<%
     			...
     			for(NoticeBean notice : noticeList){
     				...
     				String validity = notice.getNoticeValidity();
     				
     				String status = notice.getNoticeStatus();
     				
     				%>
     				
     
     		<tr> <td><%=noticeId %></td> <td><%=noticeTitle %></td> <td cols="70"><%=noticeDesc %></td><td cols="70"><%=validity %></td><td cols="70"><%=status %></td></tr>
