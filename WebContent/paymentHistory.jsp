...
<body>
	...
	<div class="container-fluid">
		...
		<div class="col-md-8">
          <div id="show">
				Payment History of Tender Bids </div>
			...
			<table style="background-color: white">
				...
				<td><%=payment.getorderCreatedAt()%></td>
				<td><%=payment.getVendorId() %></td>
				<td><%=payment.getBidId() %></td>
				<td><%=payment.getTenderId() %></td>
				<td><%=payment.getOrderAmount() %></td>
				<td><%=payment.getOrderPaymentId() %></td>
