 ...
 */
@WebServlet("/extendNoticeSrv")
public class extendNoticeSrv extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String noticeValidity = request.getParameter("validity");

		
		NoticeBean notice = new NoticeBean(noticeId, noticeTitle, noticeDesc,noticeValidity,noticeStatus);
	...
	RequestDispatcher rd = request.getRequestDispatcher("removeNotice.jsp");
		...
		pw.print("<script>document.getElementById('show').innerHTML = 'validity extended successfully'</script>");
