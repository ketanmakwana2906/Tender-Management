...
public class BidTenderSrv extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
     ...
     // Handle file upload
        ...
        String uploadPath = "D:\\Tender-Management-System-master\\Tender-Management-System-master\\tendermanagement\\WebContent\\licence_docs";
     ...
     try {
         ...
         // Calculate the percentage difference between bidAmount and basePrice
           ...
           /* if (currentTime > bidDeadline) {
            ...
            String status = dao.bidTender(tenderId, vendorId, bidAmountStr, bidDeadlineStr, points,licence);
