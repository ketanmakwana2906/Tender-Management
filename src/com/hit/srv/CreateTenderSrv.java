...
public class CreateTenderSrv extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.print(tid+" "+tname+" "+ttype+" "+tprice+" "+bexperience+" "+tdesc+" "+stdeadline+" "+tloc+" "+"completed ");
		
		TenderBean tender = new //TenderBean(id, name, type, price, desc, stdeadline, location)
				
				 TenderBean(tid,tname,ttype,tprice,tdesc,stdeadline,tloc,bexperience);
